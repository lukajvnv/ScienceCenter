...
// NECE RADITI OVO 
public class MultiEnumFormTypeCoAuthor extends EnumFormType {
	
	//protected Map<String, String> myValues;
	
	public final static String TYPE_NAME = "multiEnumCoAuthor";
	...
	public MultiEnumFormTypeCoAuthor(Map<String, String> values) {
		super(values);
